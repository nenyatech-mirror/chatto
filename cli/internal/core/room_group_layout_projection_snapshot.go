...
const roomGroupLayoutSnapshotCompatibilityID = "room-group-layout-v1"

func (*RoomGroupLayoutProjection) SnapshotCompatibilityID() string {
	return roomGroupLayoutSnapshotCompatibilityID
}
