...
/**
 * ServerEvent wraps any event delivered through the `myEvents`
...
export type MyEventsSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type MyEventsSubscription = { __typename?: 'Subscription', myEvents: { __typename?: 'ServerEvent', id: string, createdAt: any, actorId: string, actor?: (
      { __typename?: 'User' }
      & { ' $fragmentRefs'?: { 'UserAvatarUserFragment': UserAvatarUserFragment } }
    ) | null, event:
