...
- **LiveKit E2EE call keys** — stored behind the KMS boundary and shredded when calls end; if key storage is lost, active calls must reconnect into a fresh call
