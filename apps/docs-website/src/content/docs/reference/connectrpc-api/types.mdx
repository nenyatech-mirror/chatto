...
| Field | Type | Description |
| --- | --- | --- |
| `user` | [`UserSummary`](#chatto-api-v1-UserSummary) | Public identity fields. |
...
| Field | Type | Description |
| --- | --- | --- |
| `profile` | [`UserPresenceSummary`](#chatto-api-v1-UserPresenceSummary) | Public profile and live presence fields. |
